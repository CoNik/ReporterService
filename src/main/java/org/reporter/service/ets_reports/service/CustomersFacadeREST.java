...
import org.reporter.service.ets_reports.Customers;
 ...
 */
@Stateless
@Path("org.reporter.service.ets_reports.customers")
public class CustomersFacadeREST extends AbstractFacade<Customers> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Long id, Customers entity) {
        super.edit(entity);
    }
    ...
    public Customers find(@PathParam("id") Long id) {
