...
import org.reporter.service.ets_reports.Alerts;
 ...
 */
@Stateless
@Path("org.reporter.service.ets_reports.alerts")
public class AlertsFacadeREST extends AbstractFacade<Alerts> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Alerts entity) {
        super.edit(entity);
    }
    ...
    public Alerts find(@PathParam("id") Integer id) {
