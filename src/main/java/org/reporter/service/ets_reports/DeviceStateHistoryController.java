...
@Named("deviceStateHistoryController")
@RequestScoped
public class DeviceStateHistoryController implements Serializable {

    @EJB
    private org.reporter.service.ets_reports.DeviceStateHistoryFacade ejbFacade;
    private List<DeviceStateHistory> items = null;
    private DeviceStateHistory selected;
    ...
    public DeviceStateHistoryController() {
...
//        String lformat = "dd HH:mm:ss";
    ...
    public DeviceStateHistory getSelected() {
        return selected;
    }
    public void setSelected(DeviceStateHistory selected) {
    ...
    private DeviceStateHistoryFacade getFacade() {
        return ejbFacade;
    }
    public DeviceStateHistory prepareCreate() {
        selected = new DeviceStateHistory();
        initializeEmbeddableKey();
        return selected;
    }
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("DeviceStateHistoryCreated"));
        if (!JsfUtil.isValidationFailed()) {
            items = null;    // Invalidate list of items to trigger re-query.
        }
    }
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("DeviceStateHistoryUpdated"));
    }
    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("DeviceStateHistoryDeleted"));
        if (!JsfUtil.isValidationFailed()) {
            selected = null; // Remove selection
            items = null;    // Invalidate list of items to trigger re-query.
        }
    }
    public List<DeviceStateHistory> getItems() {
    ...
    private List<NoActivitiesInPeriod> getTimeSeries(Long noElements, Date dfrom, Date dto) {
        ...
        List<DeviceStateHistory> lag = getItems(dfrom, dto);
    ...
    public DeviceStateHistory getDeviceStateHistory(java.lang.Integer id) {
        return getFacade().find(id);
    }
    public List<DeviceStateHistory> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }
    public List<DeviceStateHistory> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    /**
    ...
    @FacesConverter(forClass = DeviceStateHistory.class)
    public static class DeviceStateHistoryControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            DeviceStateHistoryController controller = (DeviceStateHistoryController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "deviceStateHistoryController");
            return controller.getDeviceStateHistory(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof DeviceStateHistory) {
                DeviceStateHistory o = (DeviceStateHistory) object;
                return getStringKey(o.getId());
            } else {
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), DeviceStateHistory.class.getName()});
                return null;
            }
        }
