...
function getStationsFraudulents(){
    ...
    var url = protocol + '//' + host + '/ETS_Reports/webresources/org.reporter.service.ets_reports.fraudstations/stationsFraudulents/' 
            + startDate + '/' + endDate;
...
function getStationFraudulents(stationId){
    ...
    var url = protocol + '//' + host + '/ETS_Reports/webresources/org.reporter.service.ets_reports.fraudstations/countByPeriodAndStationId/' 
