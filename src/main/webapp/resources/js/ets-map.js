 ...
 * Each metro station contains center point
 * @returns {getMetroStations.ets-mapAnonym$0}
 */
function getMetroStations(){
    ...
    var url = protocol + '//' + host + '/ETS_Reports/webresources/org.reporter.service.ets_reports.stationpositions';
...
var stations = JSON.parse(getMetroStations());
...
stage.on('mousemove', function(evt) {
    ...
    if (shape) {
        ...
        if(shape.attrs.key){
            var passengersInStationNb = document.getElementById('passengersInSelectedStation').value;
            var smartCardTickets = document.getElementById('smartCardTicketsInSelectedStation').value;
            var mobileTickets = document.getElementById('mobileTicketsInSelectedStation').value;
            
            //build tooltip text
            let tooltipText = shape.attrs.key + "\n\n" 
                    + "Number of passengers: " + passengersInStationNb + "\n" 
                    + "Smart card tickets: " + smartCardTickets + "\n" 
